  ...
  return <main className="login-page">
    <section className="login-visual">
      <div className="login-visual-inner">
        <div className="login-brand"><img src="/oksign_logo.png" alt="OKSIGN" className="login-logo-img" /><strong>OKSIGN</strong></div>
    ...
    <section className="login-panel"><div className="login-card"><div className="login-mobile-brand"><img src="/oksign_logo.png" alt="OKSIGN" className="login-logo-img" /><strong>OKSIGN</strong></div><p className="eyebrow">ยินดีต้อนรับกลับมา</p><h2>เข้าสู่ระบบ</h2><p className="login-description">กรอกข้อมูลเพื่อเข้าใช้งาน OKSIGN Dashboard</p><LoginForm /><div className="login-help">ยังไม่มีบัญชี? <Link href="/signup">สมัครสมาชิก</Link></div></div><footer>© 2026 OKSIGN · Version 0.2.0</footer></section>
  </main>;
}
